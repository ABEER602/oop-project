...
namespace challenge1.DL
{
    class ProductCrud
    {
        ...
        public static void addIntoList(product pro)
        {
            products.Add(pro);
        }
        public static bool readUserData()
        {
            ...
            if (File.Exists(pathM))
            {
                ...
                while ((record = file.ReadLine()) != null)
                {
                    ...
                    product product = new product(name, cetagory, price, quantity);
                    addIntoList(product);
                }
                file.Close();
                return true;
        ...
        public static void saveIntoFile(product pro)
        {
        ...
        public staticproduct findHighestPrice()
        {
            int Price = 0;
