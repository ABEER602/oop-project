...
namespace UMS_WEEK_5_CHALLENGE_.BL
{
    public class Student
    {
        ...
        public Student(string name, int age, double fscMarks, double ecatMarks, double merit, List<DegreeProgram> preferences)
        {
            this.name = name;
            this.age = age;
        ...
        {
            this.merit = (((fscMarks / 1100) * 0.45F) + ((ecatMarks / 400) * 0.5F) * 100);
        }
